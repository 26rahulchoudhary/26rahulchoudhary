...
<p align="center">
  <a href="mailto:rahulchoudhary5266@gmail.com">
...
- 🔭 Building **RAG-based AI systems & LLM-powered applications**
- ⚡ Focused on **real-world AI use cases (not just experiments)**
- 🧩 Love working on **end-to-end pipelines (data → embeddings → APIs → UI)**
...
### 🔹 Berkshire Hathaway Intelligence (RAG AI Agent)
- Built a production-ready AI agent for financial Q&A  
- Designed full **RAG pipeline (ingestion → embedding → retrieval → generation)**  
- Indexed 100+ financial documents  
- ⚡ Achieved **<1s latency**  

---

### 🔹 AI Financial Document Management System
- Full-stack AI platform for financial document analysis  
- Implemented **semantic search + RAG pipeline**  
- Built APIs (FastAPI) + frontend (React)  
